...
import widget from './widgets.svg';
function Nav() {
  ...
  return (
    <div className="home-page">
        ...
        <div className="widget-icon-wrapper">
          <div className="widget-icon" style={{ backgroundImage: {widget}}}/>
        </div>
      ) : (
        <>
      ...
      <div className="div-wrapper">
        <Button className="text-wrapper-16" onClick={handleSignInClick}>Sign in</Button>
      </div>
      </>
      )}
    </div>
